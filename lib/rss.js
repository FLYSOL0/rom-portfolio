...
const generateRssItem = (post) => `
  <item>
    <guid>https://rommelielarin.com/blog/${post.fields.slug}</guid>
    <title>${post.fields.title}</title>
    <link>https://rommelielarin.com/blog/${post.fields.slug}</link>
...
const generateRss = (posts) => {
  ...
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      <title>Blog - Rommelie Larin</title>
      <link>https://rommelielarin.com/blog</link>
      <description>Designer, developer and maker of things.</description>
      <language>en</language>
      <lastBuildDate>${new Date(
        sortedPosts[0].fields.publishDate
      ).toUTCString()}</lastBuildDate>
      <atom:link href="https://rommelielarin.com/rss.xml" rel="self" type="application/rss+xml"/>
